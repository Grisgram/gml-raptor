...
load_settings();
window_enable_borderless_fullscreen(!IS_HTML && vsgetx(GAMESETTINGS, "borderless_fullscreen", FULLSCREEN_IS_BORDERLESS));
window_set_fullscreen(!IS_HTML && vsgetx(GAMESETTINGS, "start_fullscreen", START_FULLSCREEN));
