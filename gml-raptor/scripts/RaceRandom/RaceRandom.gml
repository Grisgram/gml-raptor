...
/// @func					race_random_roll_dice(dice_count, sides)
...
/// @func					race_random_percent_hit(percent)
/// @param {real} percent		The percent chance to test
/// @returns {bool}				True, if the percent chance is hit, otherwise false.
/// @desc				Convenience function to test whether a specific percent chance is hit.
